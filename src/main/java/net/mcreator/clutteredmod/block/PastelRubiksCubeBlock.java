...
public class PastelRubiksCubeBlock extends Block {
	...
	public static void clientInit() {
		BlockRenderLayerMap.INSTANCE.putBlock(LuphieclutteredmodModBlocks.PASTEL_RUBIKS_CUBE, RenderLayer.getSolid());
	}
}
