...
public class LuphieBlackLeftOuterCornerCounterBlock extends Block implements BlockEntityProvider {
	...
	public int getComparatorOutput(BlockState blockState, World world, BlockPos pos) {
		...
		if (tileentity instanceof LuphieBlackLeftOuterCornerCounterBlockEntity)
	...
	public static void clientInit() {
		BlockRenderLayerMap.INSTANCE.putBlock(LuphieclutteredmodModBlocks.LUPHIE_BLACK_LEFT_OUTER_CORNER_COUNTER, RenderLayer.getSolid());
	}
}
