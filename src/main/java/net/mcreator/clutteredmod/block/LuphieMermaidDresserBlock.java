...
public class LuphieMermaidDresserBlock extends Block implements BlockEntityProvider {
	public static Settings PROPERTIES = Settings.create().sounds(BlockSoundGroup.CORAL).strength(1f, 10f).nonOpaque().solidBlock((bs, br, bp) -> false);
	...
	public VoxelShape getOutlineShape(BlockState state, BlockView world, BlockPos pos, ShapeContext context) {
		...
		return (switch (state.get(FACING)) {
			default -> VoxelShapes.union(createCuboidShape(1, 0, 0, 31, 14, 15), createCuboidShape(0, 14, 0, 32, 16, 16));
			case NORTH -> VoxelShapes.union(createCuboidShape(-15, 0, 1, 15, 14, 16), createCuboidShape(-16, 14, 0, 16, 16, 16));
			case EAST -> VoxelShapes.union(createCuboidShape(0, 0, -15, 15, 14, 15), createCuboidShape(0, 14, -16, 16, 16, 16));
			case WEST -> VoxelShapes.union(createCuboidShape(1, 0, 1, 16, 14, 31), createCuboidShape(0, 14, 0, 16, 16, 32));
	...
	public int getComparatorOutput(BlockState blockState, World world, BlockPos pos) {
		...
		if (tileentity instanceof LuphieMermaidDresserBlockEntity)
	...
	public static void clientInit() {
		BlockRenderLayerMap.INSTANCE.putBlock(LuphieclutteredmodModBlocks.LUPHIE_MERMAID_DRESSER, RenderLayer.getCutout());
	}
}
