...
public class LuphieYellowCabinetBlock extends Block implements BlockEntityProvider {
	...
	public int getComparatorOutput(BlockState blockState, World world, BlockPos pos) {
		...
		if (tileentity instanceof LuphieYellowCabinetBlockEntity)
	...
	public static void clientInit() {
		BlockRenderLayerMap.INSTANCE.putBlock(LuphieclutteredmodModBlocks.LUPHIE_YELLOW_CABINET, RenderLayer.getSolid());
	}
}
