...
public class LuphieBlackInnerCornerCounterBlock extends Block implements BlockEntityProvider {
	...
	public int getComparatorOutput(BlockState blockState, World world, BlockPos pos) {
		...
		if (tileentity instanceof LuphieBlackInnerCornerCounterBlockEntity)
	...
	public static void clientInit() {
		BlockRenderLayerMap.INSTANCE.putBlock(LuphieclutteredmodModBlocks.LUPHIE_BLACK_INNER_CORNER_COUNTER, RenderLayer.getSolid());
	}
}
