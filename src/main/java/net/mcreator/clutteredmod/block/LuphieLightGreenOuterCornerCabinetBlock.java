...
public class LuphieLightGreenOuterCornerCabinetBlock extends Block implements BlockEntityProvider {
	...
	public VoxelShape getOutlineShape(BlockState state, BlockView world, BlockPos pos, ShapeContext context) {
		...
		return (switch (state.get(FACING)) {
			default -> VoxelShapes.union(createCuboidShape(7, 0, 0, 16, 14, 9), createCuboidShape(6, 14, 0, 16, 16, 10));
			case NORTH -> VoxelShapes.union(createCuboidShape(0, 0, 7, 9, 14, 16), createCuboidShape(0, 14, 6, 10, 16, 16));
			case EAST -> VoxelShapes.union(createCuboidShape(0, 0, 0, 9, 14, 9), createCuboidShape(0, 14, 0, 10, 16, 10));
			case WEST -> VoxelShapes.union(createCuboidShape(7, 0, 7, 16, 14, 16), createCuboidShape(6, 14, 6, 16, 16, 16));
	...
	public int getComparatorOutput(BlockState blockState, World world, BlockPos pos) {
		...
		if (tileentity instanceof LuphieLightGreenOuterCornerCabinetBlockEntity)
	...
	public static void clientInit() {
		BlockRenderLayerMap.INSTANCE.putBlock(LuphieclutteredmodModBlocks.LUPHIE_LIGHT_GREEN_OUTER_CORNER_CABINET, RenderLayer.getCutout());
	}
}
