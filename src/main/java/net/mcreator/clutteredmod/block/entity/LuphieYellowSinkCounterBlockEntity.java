...
public class LuphieYellowSinkCounterBlockEntity extends LootableContainerBlockEntity implements ScreenHandlerFactory, SidedInventory {
	...
	public LuphieYellowSinkCounterBlockEntity(BlockPos position, BlockState state) {
		super(LuphieclutteredmodModBlockEntities.LUPHIE_YELLOW_SINK_COUNTER, position, state);
	}
	...
	public Text getContainerName() {
		return Text.literal("luphie_yellow_sink_counter");
	}
	...
	public Text getDisplayName() {
		return Text.literal("Yellow Sink Counter");
	}
