...
public class LuphiePinkShelfCabinetBlockEntity extends LootableContainerBlockEntity implements ScreenHandlerFactory, SidedInventory {
	...
	public LuphiePinkShelfCabinetBlockEntity(BlockPos position, BlockState state) {
		super(LuphieclutteredmodModBlockEntities.LUPHIE_PINK_SHELF_CABINET, position, state);
	}
	...
	public Text getContainerName() {
		return Text.literal("luphie_pink_shelf_cabinet");
	}
	...
	public Text getDisplayName() {
		return Text.literal("Pink Shelf Cabinet");
	}
