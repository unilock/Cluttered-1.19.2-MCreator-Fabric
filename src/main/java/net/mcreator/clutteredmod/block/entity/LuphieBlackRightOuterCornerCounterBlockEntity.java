...
public class LuphieBlackRightOuterCornerCounterBlockEntity extends LootableContainerBlockEntity implements ScreenHandlerFactory, SidedInventory {
	...
	public LuphieBlackRightOuterCornerCounterBlockEntity(BlockPos position, BlockState state) {
		super(LuphieclutteredmodModBlockEntities.LUPHIE_BLACK_RIGHT_OUTER_CORNER_COUNTER, position, state);
	}
	...
	public Text getContainerName() {
		return Text.literal("luphie_black_right_outer_corner_counter");
	}
	...
	public Text getDisplayName() {
		return Text.literal("Black Right Outer Corner Counter");
	}
