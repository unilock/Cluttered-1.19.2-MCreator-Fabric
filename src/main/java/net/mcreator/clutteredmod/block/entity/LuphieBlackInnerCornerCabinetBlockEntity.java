...
public class LuphieBlackInnerCornerCabinetBlockEntity extends LootableContainerBlockEntity implements ScreenHandlerFactory, SidedInventory {
	...
	public LuphieBlackInnerCornerCabinetBlockEntity(BlockPos position, BlockState state) {
		super(LuphieclutteredmodModBlockEntities.LUPHIE_BLACK_INNER_CORNER_CABINET, position, state);
	}
	...
	public Text getContainerName() {
		return Text.literal("luphie_black_inner_corner_cabinet");
	}
	...
	public Text getDisplayName() {
		return Text.literal("Black Inner Corner Cabinet");
	}
