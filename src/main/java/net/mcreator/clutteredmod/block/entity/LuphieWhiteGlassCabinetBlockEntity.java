...
public class LuphieWhiteGlassCabinetBlockEntity extends LootableContainerBlockEntity implements ScreenHandlerFactory, SidedInventory {
	...
	public LuphieWhiteGlassCabinetBlockEntity(BlockPos position, BlockState state) {
		super(LuphieclutteredmodModBlockEntities.LUPHIE_WHITE_GLASS_CABINET, position, state);
	}
	...
	public Text getContainerName() {
		return Text.literal("luphie_white_glass_cabinet");
	}
	...
	public Text getDisplayName() {
		return Text.literal("White Glass Cabinet");
	}
