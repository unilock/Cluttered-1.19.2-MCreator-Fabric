...
public class LuphieYellowOuterCornerCabinetBlockEntity extends LootableContainerBlockEntity implements ScreenHandlerFactory, SidedInventory {
	...
	public LuphieYellowOuterCornerCabinetBlockEntity(BlockPos position, BlockState state) {
		super(LuphieclutteredmodModBlockEntities.LUPHIE_YELLOW_OUTER_CORNER_CABINET, position, state);
	}
	...
	public Text getContainerName() {
		return Text.literal("luphie_yellow_outer_corner_cabinet");
	}
	...
	public Text getDisplayName() {
		return Text.literal("Yellow Outer Corner Cabinet");
	}
