...
public class LuphieYellowInnerCornerCabinetBlockEntity extends LootableContainerBlockEntity implements ScreenHandlerFactory, SidedInventory {
	...
	public LuphieYellowInnerCornerCabinetBlockEntity(BlockPos position, BlockState state) {
		super(LuphieclutteredmodModBlockEntities.LUPHIE_YELLOW_INNER_CORNER_CABINET, position, state);
	}
	...
	public Text getContainerName() {
		return Text.literal("luphie_yellow_inner_corner_cabinet");
	}
	...
	public Text getDisplayName() {
		return Text.literal("Yellow Inner Corner Cabinet");
	}
