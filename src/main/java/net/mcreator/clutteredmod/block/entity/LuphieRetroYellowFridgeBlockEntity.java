...
public class LuphieRetroYellowFridgeBlockEntity extends LootableContainerBlockEntity implements ScreenHandlerFactory, SidedInventory {
	...
	public LuphieRetroYellowFridgeBlockEntity(BlockPos position, BlockState state) {
		super(LuphieclutteredmodModBlockEntities.LUPHIE_RETRO_YELLOW_FRIDGE, position, state);
	}
	...
	public Text getContainerName() {
		return Text.literal("luphie_retro_yellow_fridge");
	}
	...
	public Text getDisplayName() {
		return Text.literal("Yellow Retro Fridge");
	}
