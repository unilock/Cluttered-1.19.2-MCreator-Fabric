...
public class LuphieLightGreenShelfCabinetBlockEntity extends LootableContainerBlockEntity implements ScreenHandlerFactory, SidedInventory {
	...
	public LuphieLightGreenShelfCabinetBlockEntity(BlockPos position, BlockState state) {
		super(LuphieclutteredmodModBlockEntities.LUPHIE_LIGHT_GREEN_SHELF_CABINET, position, state);
	}
	...
	public Text getContainerName() {
		return Text.literal("luphie_light_green_shelf_cabinet");
	}
	...
	public Text getDisplayName() {
		return Text.literal("Light Green Shelf Cabinet");
	}
