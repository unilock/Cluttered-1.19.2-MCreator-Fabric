...
public class LuphieDoradoCabinetClutteredBlockEntity extends LootableContainerBlockEntity implements ScreenHandlerFactory, SidedInventory {
	...
	public LuphieDoradoCabinetClutteredBlockEntity(BlockPos position, BlockState state) {
		super(LuphieclutteredmodModBlockEntities.LUPHIE_DORADO_CABINET_CLUTTERED, position, state);
	}
	...
	public Text getContainerName() {
		return Text.literal("luphie_dorado_cabinet_cluttered");
	}
	...
	public Text getDisplayName() {
		return Text.literal("Cluttered Dorado Cabinet");
	}
