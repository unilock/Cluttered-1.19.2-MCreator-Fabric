...
public class LuphieWhiteOuterCornerCabinetBlockEntity extends LootableContainerBlockEntity implements ScreenHandlerFactory, SidedInventory {
	...
	public LuphieWhiteOuterCornerCabinetBlockEntity(BlockPos position, BlockState state) {
		super(LuphieclutteredmodModBlockEntities.LUPHIE_WHITE_OUTER_CORNER_CABINET, position, state);
	}
	...
	public Text getContainerName() {
		return Text.literal("luphie_white_outer_corner_cabinet");
	}
	...
	public Text getDisplayName() {
		return Text.literal("White Outer Corner Cabinet");
	}
