...
public class LuphieRoversBriefcaseBlockEntity extends LootableContainerBlockEntity implements ScreenHandlerFactory, SidedInventory {
	...
	public LuphieRoversBriefcaseBlockEntity(BlockPos position, BlockState state) {
		super(LuphieclutteredmodModBlockEntities.LUPHIE_ROVERS_BRIEFCASE, position, state);
	}
	...
	public Text getContainerName() {
		return Text.literal("luphie_rovers_briefcase");
	}
	...
	public Text getDisplayName() {
		return Text.literal("Rover's Briefcase");
	}
