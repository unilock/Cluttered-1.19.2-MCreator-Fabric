...
public class LuphieLightGreenMiniCabinetBlockEntity extends LootableContainerBlockEntity implements ScreenHandlerFactory, SidedInventory {
	...
	public LuphieLightGreenMiniCabinetBlockEntity(BlockPos position, BlockState state) {
		super(LuphieclutteredmodModBlockEntities.LUPHIE_LIGHT_GREEN_MINI_CABINET, position, state);
	}
	...
	public Text getContainerName() {
		return Text.literal("luphie_light_green_mini_cabinet");
	}
	...
	public Text getDisplayName() {
		return Text.literal("Light Green Mini Cabinet");
	}
