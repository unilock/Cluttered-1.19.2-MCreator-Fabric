...
public class LuphieDoradoCabinetBlockEntity extends LootableContainerBlockEntity implements ScreenHandlerFactory, SidedInventory {
	...
	public LuphieDoradoCabinetBlockEntity(BlockPos position, BlockState state) {
		super(LuphieclutteredmodModBlockEntities.LUPHIE_DORADO_CABINET, position, state);
	}
	...
	public Text getContainerName() {
		return Text.literal("luphie_dorado_cabinet");
	}
	...
	public Text getDisplayName() {
		return Text.literal("Dorado Cabinet");
	}
