...
public class LuphieBlackEndtableBlockEntity extends LootableContainerBlockEntity implements ScreenHandlerFactory, SidedInventory {
	private DefaultedList<ItemStack> stacks = DefaultedList.<ItemStack>ofSize(27, ItemStack.EMPTY);

	public LuphieBlackEndtableBlockEntity(BlockPos position, BlockState state) {
		super(LuphieclutteredmodModBlockEntities.LUPHIE_BLACK_ENDTABLE, position, state);
	}
	...
	public Text getContainerName() {
		return Text.literal("luphie_black_endtable");
	}
	...
	public Text getDisplayName() {
		return Text.literal("Black Endtable");
	}
