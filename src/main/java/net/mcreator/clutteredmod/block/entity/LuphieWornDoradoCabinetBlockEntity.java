...
public class LuphieWornDoradoCabinetBlockEntity extends LootableContainerBlockEntity implements ScreenHandlerFactory, SidedInventory {
	...
	public LuphieWornDoradoCabinetBlockEntity(BlockPos position, BlockState state) {
		super(LuphieclutteredmodModBlockEntities.LUPHIE_WORN_DORADO_CABINET, position, state);
	}
	...
	public Text getContainerName() {
		return Text.literal("luphie_worn_dorado_cabinet");
	}
	...
	public Text getDisplayName() {
		return Text.literal("Worn Dorado Cabinet");
	}
