...
public class LuphieGreenerNightstandBlockEntity extends LootableContainerBlockEntity implements ScreenHandlerFactory, SidedInventory {
	...
	public LuphieGreenerNightstandBlockEntity(BlockPos position, BlockState state) {
		super(LuphieclutteredmodModBlockEntities.LUPHIE_GREENER_NIGHTSTAND, position, state);
	}
	...
	public Text getContainerName() {
		return Text.literal("luphie_greener_nightstand");
	}
	...
	public Text getDisplayName() {
		return Text.literal("Greener Nightstand");
	}
