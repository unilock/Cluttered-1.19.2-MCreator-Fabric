...
public class LuphieRetroBlackFridgeBlockEntity extends LootableContainerBlockEntity implements ScreenHandlerFactory, SidedInventory {
	...
	public LuphieRetroBlackFridgeBlockEntity(BlockPos position, BlockState state) {
		super(LuphieclutteredmodModBlockEntities.LUPHIE_RETRO_BLACK_FRIDGE, position, state);
	}
	...
	public Text getContainerName() {
		return Text.literal("luphie_retro_black_fridge");
	}
	...
	public Text getDisplayName() {
		return Text.literal("Black Retro Fridge");
	}
