...
public class LuphieHavanaCabinetBlockEntity extends LootableContainerBlockEntity implements ScreenHandlerFactory, SidedInventory {
	...
	public LuphieHavanaCabinetBlockEntity(BlockPos position, BlockState state) {
		super(LuphieclutteredmodModBlockEntities.LUPHIE_HAVANA_CABINET, position, state);
	}
	...
	public Text getContainerName() {
		return Text.literal("luphie_havana_cabinet");
	}
	...
	public Text getDisplayName() {
		return Text.literal("Havana Cabinet");
	}
