...
public class LuphieBlackGlassCabinetBlockEntity extends LootableContainerBlockEntity implements ScreenHandlerFactory, SidedInventory {
	...
	public LuphieBlackGlassCabinetBlockEntity(BlockPos position, BlockState state) {
		super(LuphieclutteredmodModBlockEntities.LUPHIE_BLACK_GLASS_CABINET, position, state);
	}
	...
	public Text getContainerName() {
		return Text.literal("luphie_black_glass_cabinet");
	}
	...
	public Text getDisplayName() {
		return Text.literal("Black Glass Cabinet");
	}
