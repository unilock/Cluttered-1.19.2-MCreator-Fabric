...
public class LuphieCatKitchenCounterBBlockEntity extends LootableContainerBlockEntity implements ScreenHandlerFactory, SidedInventory {
	...
	public LuphieCatKitchenCounterBBlockEntity(BlockPos position, BlockState state) {
		super(LuphieclutteredmodModBlockEntities.LUPHIE_CAT_KITCHEN_COUNTER_B, position, state);
	}
	...
	public Text getContainerName() {
		return Text.literal("luphie_cat_kitchen_counter_b");
	}
	...
	public Text getDisplayName() {
		return Text.literal("Cat Counter B");
	}
