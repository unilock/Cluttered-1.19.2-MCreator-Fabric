...
public class LuphieBlackOuterCornerCabinetBlockEntity extends LootableContainerBlockEntity implements ScreenHandlerFactory, SidedInventory {
	...
	public LuphieBlackOuterCornerCabinetBlockEntity(BlockPos position, BlockState state) {
		super(LuphieclutteredmodModBlockEntities.LUPHIE_BLACK_OUTER_CORNER_CABINET, position, state);
	}
	...
	public Text getContainerName() {
		return Text.literal("luphie_black_outer_corner_cabinet");
	}
	...
	public Text getDisplayName() {
		return Text.literal("Black Outer Corner Cabinet");
	}
