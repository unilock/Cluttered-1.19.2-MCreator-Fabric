...
public class LuphieWhiteLeftOuterCornerCounterBlockEntity extends LootableContainerBlockEntity implements ScreenHandlerFactory, SidedInventory {
	...
	public LuphieWhiteLeftOuterCornerCounterBlockEntity(BlockPos position, BlockState state) {
		super(LuphieclutteredmodModBlockEntities.LUPHIE_WHITE_LEFT_OUTER_CORNER_COUNTER, position, state);
	}
	...
	public Text getContainerName() {
		return Text.literal("luphie_white_left_outer_corner_counter");
	}
	...
	public Text getDisplayName() {
		return Text.literal("White Left Outer Corner Counter");
	}
