...
public class LuphieAmethystEndtableBlockEntity extends LootableContainerBlockEntity implements ScreenHandlerFactory, SidedInventory {
	private DefaultedList<ItemStack> stacks = DefaultedList.<ItemStack>ofSize(27, ItemStack.EMPTY);

	public LuphieAmethystEndtableBlockEntity(BlockPos position, BlockState state) {
		super(LuphieclutteredmodModBlockEntities.LUPHIE_AMETHYST_ENDTABLE, position, state);
	}
	...
	public Text getContainerName() {
		return Text.literal("luphie_amethyst_endtable");
	}
	...
	public Text getDisplayName() {
		return Text.literal("Amethyst Endtable");
	}
