...
public class LuphieBlackSinkCounterBlockEntity extends LootableContainerBlockEntity implements ScreenHandlerFactory, SidedInventory {
	...
	public LuphieBlackSinkCounterBlockEntity(BlockPos position, BlockState state) {
		super(LuphieclutteredmodModBlockEntities.LUPHIE_BLACK_SINK_COUNTER, position, state);
	}
	...
	public Text getContainerName() {
		return Text.literal("luphie_black_sink_counter");
	}
	...
	public Text getDisplayName() {
		return Text.literal("Black Sink Counter");
	}
