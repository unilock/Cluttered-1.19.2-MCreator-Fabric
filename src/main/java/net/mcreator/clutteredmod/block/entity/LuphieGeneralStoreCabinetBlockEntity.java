...
public class LuphieGeneralStoreCabinetBlockEntity extends LootableContainerBlockEntity implements ScreenHandlerFactory, SidedInventory {
	private DefaultedList<ItemStack> stacks = DefaultedList.<ItemStack>ofSize(56, ItemStack.EMPTY);

	public LuphieGeneralStoreCabinetBlockEntity(BlockPos position, BlockState state) {
		super(LuphieclutteredmodModBlockEntities.LUPHIE_GENERAL_STORE_CABINET, position, state);
	}
	...
	public Text getContainerName() {
		return Text.literal("luphie_general_store_cabinet");
	}
	...
	public Text getDisplayName() {
		return Text.literal("General Store Cabinet");
	}
