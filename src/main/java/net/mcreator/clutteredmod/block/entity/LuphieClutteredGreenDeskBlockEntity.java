...
public class LuphieClutteredGreenDeskBlockEntity extends LootableContainerBlockEntity implements ScreenHandlerFactory, SidedInventory {
	...
	public LuphieClutteredGreenDeskBlockEntity(BlockPos position, BlockState state) {
		super(LuphieclutteredmodModBlockEntities.LUPHIE_CLUTTERED_GREEN_DESK, position, state);
	}
	...
	public Text getContainerName() {
		return Text.literal("luphie_cluttered_green_desk");
	}
	...
	public Text getDisplayName() {
		return Text.literal("Cluttered Green Desk");
	}
