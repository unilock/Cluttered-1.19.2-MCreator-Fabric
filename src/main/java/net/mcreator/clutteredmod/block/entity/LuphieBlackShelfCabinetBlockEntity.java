...
public class LuphieBlackShelfCabinetBlockEntity extends LootableContainerBlockEntity implements ScreenHandlerFactory, SidedInventory {
	...
	public LuphieBlackShelfCabinetBlockEntity(BlockPos position, BlockState state) {
		super(LuphieclutteredmodModBlockEntities.LUPHIE_BLACK_SHELF_CABINET, position, state);
	}
	...
	public Text getContainerName() {
		return Text.literal("luphie_black_shelf_cabinet");
	}
	...
	public Text getDisplayName() {
		return Text.literal("Black Shelf Cabinet");
	}
