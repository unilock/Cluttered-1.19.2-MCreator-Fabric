...
public class LuphieRetroWhiteFridgeBlockEntity extends LootableContainerBlockEntity implements ScreenHandlerFactory, SidedInventory {
	...
	public LuphieRetroWhiteFridgeBlockEntity(BlockPos position, BlockState state) {
		super(LuphieclutteredmodModBlockEntities.LUPHIE_RETRO_WHITE_FRIDGE, position, state);
	}
	...
	public Text getContainerName() {
		return Text.literal("luphie_retro_white_fridge");
	}
	...
	public Text getDisplayName() {
		return Text.literal("White Retro Fridge");
	}
