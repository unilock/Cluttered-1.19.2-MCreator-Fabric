...
public class LuphieLightGreenCounterBlockEntity extends LootableContainerBlockEntity implements ScreenHandlerFactory, SidedInventory {
	...
	public LuphieLightGreenCounterBlockEntity(BlockPos position, BlockState state) {
		super(LuphieclutteredmodModBlockEntities.LUPHIE_LIGHT_GREEN_COUNTER, position, state);
	}
	...
	public Text getContainerName() {
		return Text.literal("luphie_light_green_counter");
	}
	...
	public Text getDisplayName() {
		return Text.literal("Light Green Counter");
	}
