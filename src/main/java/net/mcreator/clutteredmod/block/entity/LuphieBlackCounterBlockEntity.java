...
public class LuphieBlackCounterBlockEntity extends LootableContainerBlockEntity implements ScreenHandlerFactory, SidedInventory {
	...
	public LuphieBlackCounterBlockEntity(BlockPos position, BlockState state) {
		super(LuphieclutteredmodModBlockEntities.LUPHIE_BLACK_COUNTER, position, state);
	}
	...
	public Text getContainerName() {
		return Text.literal("luphie_black_counter");
	}
	...
	public Text getDisplayName() {
		return Text.literal("Black Counter");
	}
