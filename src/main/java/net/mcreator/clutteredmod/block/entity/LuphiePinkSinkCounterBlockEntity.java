...
public class LuphiePinkSinkCounterBlockEntity extends LootableContainerBlockEntity implements ScreenHandlerFactory, SidedInventory {
	...
	public LuphiePinkSinkCounterBlockEntity(BlockPos position, BlockState state) {
		super(LuphieclutteredmodModBlockEntities.LUPHIE_PINK_SINK_COUNTER, position, state);
	}
	...
	public Text getContainerName() {
		return Text.literal("luphie_pink_sink_counter");
	}
	...
	public Text getDisplayName() {
		return Text.literal("Pink Sink Counter");
	}
