...
public class LuphieMushroomChestBlockEntity extends LootableContainerBlockEntity implements ScreenHandlerFactory, SidedInventory {
	...
	public LuphieMushroomChestBlockEntity(BlockPos position, BlockState state) {
		super(LuphieclutteredmodModBlockEntities.LUPHIE_MUSHROOM_CHEST, position, state);
	}
	...
	public Text getContainerName() {
		return Text.literal("luphie_mushroom_chest");
	}
	...
	public Text getDisplayName() {
		return Text.literal("Mushroom Chest");
	}
