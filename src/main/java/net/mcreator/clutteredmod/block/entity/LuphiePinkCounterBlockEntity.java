...
public class LuphiePinkCounterBlockEntity extends LootableContainerBlockEntity implements ScreenHandlerFactory, SidedInventory {
	...
	public LuphiePinkCounterBlockEntity(BlockPos position, BlockState state) {
		super(LuphieclutteredmodModBlockEntities.LUPHIE_PINK_COUNTER, position, state);
	}
	...
	public Text getContainerName() {
		return Text.literal("luphie_pink_counter");
	}
	...
	public Text getDisplayName() {
		return Text.literal("Pink Counter");
	}
