...
public class LuphieYellowCabinetBlockEntity extends LootableContainerBlockEntity implements ScreenHandlerFactory, SidedInventory {
	...
	public LuphieYellowCabinetBlockEntity(BlockPos position, BlockState state) {
		super(LuphieclutteredmodModBlockEntities.LUPHIE_YELLOW_CABINET, position, state);
	}
	...
	public Text getContainerName() {
		return Text.literal("luphie_yellow_cabinet");
	}
	...
	public Text getDisplayName() {
		return Text.literal("Yellow Cabinet");
	}
