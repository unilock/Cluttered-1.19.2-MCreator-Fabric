...
public class LuphieBrownDeskBlockEntity extends LootableContainerBlockEntity implements ScreenHandlerFactory, SidedInventory {
	...
	public LuphieBrownDeskBlockEntity(BlockPos position, BlockState state) {
		super(LuphieclutteredmodModBlockEntities.LUPHIE_BROWN_DESK, position, state);
	}
	...
	public Text getContainerName() {
		return Text.literal("luphie_brown_desk");
	}
	...
	public Text getDisplayName() {
		return Text.literal("Brown Desk");
	}
