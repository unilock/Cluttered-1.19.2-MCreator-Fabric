...
public class LuphiePinkLeftOuterCornerCounterBlockEntity extends LootableContainerBlockEntity implements ScreenHandlerFactory, SidedInventory {
	...
	public LuphiePinkLeftOuterCornerCounterBlockEntity(BlockPos position, BlockState state) {
		super(LuphieclutteredmodModBlockEntities.LUPHIE_PINK_LEFT_OUTER_CORNER_COUNTER, position, state);
	}
	...
	public Text getContainerName() {
		return Text.literal("luphie_pink_left_outer_corner_counter");
	}
	...
	public Text getDisplayName() {
		return Text.literal("Pink Left Outer Corner Counter");
	}
