...
public class LuphieLightGreenInnerCornerCounterBlockEntity extends LootableContainerBlockEntity implements ScreenHandlerFactory, SidedInventory {
	...
	public LuphieLightGreenInnerCornerCounterBlockEntity(BlockPos position, BlockState state) {
		super(LuphieclutteredmodModBlockEntities.LUPHIE_LIGHT_GREEN_INNER_CORNER_COUNTER, position, state);
	}
	...
	public Text getContainerName() {
		return Text.literal("luphie_light_green_inner_corner_counter");
	}
	...
	public Text getDisplayName() {
		return Text.literal("Light Green Inner Corner Counter");
	}
