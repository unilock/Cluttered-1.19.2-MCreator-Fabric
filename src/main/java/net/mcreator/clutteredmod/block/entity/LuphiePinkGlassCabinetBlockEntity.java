...
public class LuphiePinkGlassCabinetBlockEntity extends LootableContainerBlockEntity implements ScreenHandlerFactory, SidedInventory {
	...
	public LuphiePinkGlassCabinetBlockEntity(BlockPos position, BlockState state) {
		super(LuphieclutteredmodModBlockEntities.LUPHIE_PINK_GLASS_CABINET, position, state);
	}
	...
	public Text getContainerName() {
		return Text.literal("luphie_pink_glass_cabinet");
	}
	...
	public Text getDisplayName() {
		return Text.literal("Pink Glass Cabinet");
	}
