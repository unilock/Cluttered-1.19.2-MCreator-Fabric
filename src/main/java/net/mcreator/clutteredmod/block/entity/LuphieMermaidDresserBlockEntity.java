...
public class LuphieMermaidDresserBlockEntity extends LootableContainerBlockEntity implements ScreenHandlerFactory, SidedInventory {
	...
	public LuphieMermaidDresserBlockEntity(BlockPos position, BlockState state) {
		super(LuphieclutteredmodModBlockEntities.LUPHIE_MERMAID_DRESSER, position, state);
	}
	...
	public Text getContainerName() {
		return Text.literal("luphie_mermaid_dresser");
	}
	...
	public Text getDisplayName() {
		return Text.literal("Mermaid Dresser");
	}
