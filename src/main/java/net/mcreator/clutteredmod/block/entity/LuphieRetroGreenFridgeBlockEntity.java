...
public class LuphieRetroGreenFridgeBlockEntity extends LootableContainerBlockEntity implements ScreenHandlerFactory, SidedInventory {
	...
	public LuphieRetroGreenFridgeBlockEntity(BlockPos position, BlockState state) {
		super(LuphieclutteredmodModBlockEntities.LUPHIE_RETRO_GREEN_FRIDGE, position, state);
	}
	...
	public Text getContainerName() {
		return Text.literal("luphie_retro_green_fridge");
	}
	...
	public Text getDisplayName() {
		return Text.literal("Green Retro Fridge");
	}
