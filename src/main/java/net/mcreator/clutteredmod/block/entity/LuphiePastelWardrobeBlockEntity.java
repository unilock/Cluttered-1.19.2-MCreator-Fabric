...
public class LuphiePastelWardrobeBlockEntity extends LootableContainerBlockEntity implements ScreenHandlerFactory, SidedInventory {
	...
	public LuphiePastelWardrobeBlockEntity(BlockPos position, BlockState state) {
		super(LuphieclutteredmodModBlockEntities.LUPHIE_PASTEL_WARDROBE, position, state);
	}
	...
	public Text getContainerName() {
		return Text.literal("luphie_pastel_wardrobe");
	}
	...
	public Text getDisplayName() {
		return Text.literal("Pastel Wardrobe");
	}
