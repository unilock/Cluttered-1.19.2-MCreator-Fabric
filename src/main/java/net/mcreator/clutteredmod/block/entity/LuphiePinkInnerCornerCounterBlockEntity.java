...
public class LuphiePinkInnerCornerCounterBlockEntity extends LootableContainerBlockEntity implements ScreenHandlerFactory, SidedInventory {
	...
	public LuphiePinkInnerCornerCounterBlockEntity(BlockPos position, BlockState state) {
		super(LuphieclutteredmodModBlockEntities.LUPHIE_PINK_INNER_CORNER_COUNTER, position, state);
	}
	...
	public Text getContainerName() {
		return Text.literal("luphie_pink_inner_corner_counter");
	}
	...
	public Text getDisplayName() {
		return Text.literal("Pink Inner Corner Counter");
	}
