...
public class LuphieWhiteRightOuterCornerCounterBlockEntity extends LootableContainerBlockEntity implements ScreenHandlerFactory, SidedInventory {
	...
	public LuphieWhiteRightOuterCornerCounterBlockEntity(BlockPos position, BlockState state) {
		super(LuphieclutteredmodModBlockEntities.LUPHIE_WHITE_RIGHT_OUTER_CORNER_COUNTER, position, state);
	}
	...
	public Text getContainerName() {
		return Text.literal("luphie_white_right_outer_corner_counter");
	}
	...
	public Text getDisplayName() {
		return Text.literal("White Right Outer Corner Counter");
	}
