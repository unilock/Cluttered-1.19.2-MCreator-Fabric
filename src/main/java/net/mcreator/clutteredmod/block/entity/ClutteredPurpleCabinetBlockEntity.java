...
public class ClutteredPurpleCabinetBlockEntity extends LootableContainerBlockEntity implements ScreenHandlerFactory, SidedInventory {
	private DefaultedList<ItemStack> stacks = DefaultedList.<ItemStack>ofSize(54, ItemStack.EMPTY);

	public ClutteredPurpleCabinetBlockEntity(BlockPos position, BlockState state) {
		super(LuphieclutteredmodModBlockEntities.CLUTTERED_PURPLE_CABINET, position, state);
	}
	...
	public Text getContainerName() {
		return Text.literal("cluttered_purple_cabinet");
	}
	...
	public Text getDisplayName() {
		return Text.literal("Cluttered Purple Cabinet");
	}
