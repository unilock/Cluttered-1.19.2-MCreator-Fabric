...
public class LuphieLightGreenGlassCabinetBlockEntity extends LootableContainerBlockEntity implements ScreenHandlerFactory, SidedInventory {
	...
	public LuphieLightGreenGlassCabinetBlockEntity(BlockPos position, BlockState state) {
		super(LuphieclutteredmodModBlockEntities.LUPHIE_LIGHT_GREEN_GLASS_CABINET, position, state);
	}
	...
	public Text getContainerName() {
		return Text.literal("luphie_light_green_glass_cabinet");
	}
	...
	public Text getDisplayName() {
		return Text.literal("Light Green Glass Cabinet");
	}
