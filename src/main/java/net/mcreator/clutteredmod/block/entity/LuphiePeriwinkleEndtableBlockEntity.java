...
public class LuphiePeriwinkleEndtableBlockEntity extends LootableContainerBlockEntity implements ScreenHandlerFactory, SidedInventory {
	private DefaultedList<ItemStack> stacks = DefaultedList.<ItemStack>ofSize(27, ItemStack.EMPTY);

	public LuphiePeriwinkleEndtableBlockEntity(BlockPos position, BlockState state) {
		super(LuphieclutteredmodModBlockEntities.LUPHIE_PERIWINKLE_ENDTABLE, position, state);
	}
	...
	public Text getContainerName() {
		return Text.literal("luphie_periwinkle_endtable");
	}
	...
	public Text getDisplayName() {
		return Text.literal("Periwinkle Endtable");
	}
