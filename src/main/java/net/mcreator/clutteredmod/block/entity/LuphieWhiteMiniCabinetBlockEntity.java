...
public class LuphieWhiteMiniCabinetBlockEntity extends LootableContainerBlockEntity implements ScreenHandlerFactory, SidedInventory {
	...
	public LuphieWhiteMiniCabinetBlockEntity(BlockPos position, BlockState state) {
		super(LuphieclutteredmodModBlockEntities.LUPHIE_WHITE_MINI_CABINET, position, state);
	}
	...
	public Text getContainerName() {
		return Text.literal("luphie_white_mini_cabinet");
	}
	...
	public Text getDisplayName() {
		return Text.literal("White Mini Cabinet");
	}
