...
public class LuphieYellowMiniCabinetBlockEntity extends LootableContainerBlockEntity implements ScreenHandlerFactory, SidedInventory {
	...
	public LuphieYellowMiniCabinetBlockEntity(BlockPos position, BlockState state) {
		super(LuphieclutteredmodModBlockEntities.LUPHIE_YELLOW_MINI_CABINET, position, state);
	}
	...
	public Text getContainerName() {
		return Text.literal("luphie_yellow_mini_cabinet");
	}
	...
	public Text getDisplayName() {
		return Text.literal("Yellow Mini Cabinet");
	}
