...
public class LuphieGreenDeskBlockEntity extends LootableContainerBlockEntity implements ScreenHandlerFactory, SidedInventory {
	...
	public LuphieGreenDeskBlockEntity(BlockPos position, BlockState state) {
		super(LuphieclutteredmodModBlockEntities.LUPHIE_GREEN_DESK, position, state);
	}
	...
	public Text getContainerName() {
		return Text.literal("luphie_green_desk");
	}
	...
	public Text getDisplayName() {
		return Text.literal("Green Desk");
	}
