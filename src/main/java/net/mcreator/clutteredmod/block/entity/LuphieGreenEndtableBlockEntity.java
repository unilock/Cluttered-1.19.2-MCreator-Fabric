...
public class LuphieGreenEndtableBlockEntity extends LootableContainerBlockEntity implements ScreenHandlerFactory, SidedInventory {
	private DefaultedList<ItemStack> stacks = DefaultedList.<ItemStack>ofSize(27, ItemStack.EMPTY);

	public LuphieGreenEndtableBlockEntity(BlockPos position, BlockState state) {
		super(LuphieclutteredmodModBlockEntities.LUPHIE_GREEN_ENDTABLE, position, state);
	}
	...
	public Text getContainerName() {
		return Text.literal("luphie_green_endtable");
	}
	...
	public Text getDisplayName() {
		return Text.literal("Green Endtable");
	}
