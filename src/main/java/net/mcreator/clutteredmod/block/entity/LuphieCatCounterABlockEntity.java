...
public class LuphieCatCounterABlockEntity extends LootableContainerBlockEntity implements ScreenHandlerFactory, SidedInventory {
	...
	public LuphieCatCounterABlockEntity(BlockPos position, BlockState state) {
		super(LuphieclutteredmodModBlockEntities.LUPHIE_CAT_COUNTER_A, position, state);
	}
	...
	public Text getContainerName() {
		return Text.literal("luphie_cat_counter_a");
	}
	...
	public Text getDisplayName() {
		return Text.literal("Cat Counter A");
	}
