...
public class LuphieLightGreenCabinetBlockEntity extends LootableContainerBlockEntity implements ScreenHandlerFactory, SidedInventory {
	...
	public LuphieLightGreenCabinetBlockEntity(BlockPos position, BlockState state) {
		super(LuphieclutteredmodModBlockEntities.LUPHIE_LIGHT_GREEN_CABINET, position, state);
	}
	...
	public Text getContainerName() {
		return Text.literal("luphie_light_green_cabinet");
	}
	...
	public Text getDisplayName() {
		return Text.literal("Light Green Cabinet");
	}
