...
public class LuphiePinkOuterCornerCabinetBlockEntity extends LootableContainerBlockEntity implements ScreenHandlerFactory, SidedInventory {
	...
	public LuphiePinkOuterCornerCabinetBlockEntity(BlockPos position, BlockState state) {
		super(LuphieclutteredmodModBlockEntities.LUPHIE_PINK_OUTER_CORNER_CABINET, position, state);
	}
	...
	public Text getContainerName() {
		return Text.literal("luphie_pink_outer_corner_cabinet");
	}
	...
	public Text getDisplayName() {
		return Text.literal("Pink Outer Corner Cabinet");
	}
