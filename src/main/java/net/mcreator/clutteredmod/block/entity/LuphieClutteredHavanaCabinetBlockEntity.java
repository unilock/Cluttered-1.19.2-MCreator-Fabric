...
public class LuphieClutteredHavanaCabinetBlockEntity extends LootableContainerBlockEntity implements ScreenHandlerFactory, SidedInventory {
	...
	public LuphieClutteredHavanaCabinetBlockEntity(BlockPos position, BlockState state) {
		super(LuphieclutteredmodModBlockEntities.LUPHIE_CLUTTERED_HAVANA_CABINET, position, state);
	}
	...
	public Text getContainerName() {
		return Text.literal("luphie_cluttered_havana_cabinet");
	}
	...
	public Text getDisplayName() {
		return Text.literal("Cluttered Havana Cabinet");
	}
