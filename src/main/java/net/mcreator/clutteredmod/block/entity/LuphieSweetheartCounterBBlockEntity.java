...
public class LuphieSweetheartCounterBBlockEntity extends LootableContainerBlockEntity implements ScreenHandlerFactory, SidedInventory {
	...
	public LuphieSweetheartCounterBBlockEntity(BlockPos position, BlockState state) {
		super(LuphieclutteredmodModBlockEntities.LUPHIE_SWEETHEART_COUNTER_B, position, state);
	}
	...
	public Text getContainerName() {
		return Text.literal("luphie_sweetheart_counter_b");
	}
	...
	public Text getDisplayName() {
		return Text.literal("Sweetheart Counter B");
	}
