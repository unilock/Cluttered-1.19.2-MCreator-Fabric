...
public class LuphieClutteredDeskBlockEntity extends LootableContainerBlockEntity implements ScreenHandlerFactory, SidedInventory {
	...
	public LuphieClutteredDeskBlockEntity(BlockPos position, BlockState state) {
		super(LuphieclutteredmodModBlockEntities.LUPHIE_CLUTTERED_DESK, position, state);
	}
	...
	public Text getContainerName() {
		return Text.literal("luphie_cluttered_desk");
	}
	...
	public Text getDisplayName() {
		return Text.literal("Cluttered Brown Desk");
	}
