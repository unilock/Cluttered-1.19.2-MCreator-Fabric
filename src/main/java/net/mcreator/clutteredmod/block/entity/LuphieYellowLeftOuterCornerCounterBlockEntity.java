...
public class LuphieYellowLeftOuterCornerCounterBlockEntity extends LootableContainerBlockEntity implements ScreenHandlerFactory, SidedInventory {
	...
	public LuphieYellowLeftOuterCornerCounterBlockEntity(BlockPos position, BlockState state) {
		super(LuphieclutteredmodModBlockEntities.LUPHIE_YELLOW_LEFT_OUTER_CORNER_COUNTER, position, state);
	}
	...
	public Text getContainerName() {
		return Text.literal("luphie_yellow_left_outer_corner_counter");
	}
	...
	public Text getDisplayName() {
		return Text.literal("Yellow Left Outer Corner Counter");
	}
