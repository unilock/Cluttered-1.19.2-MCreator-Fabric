...
public class LuphieMushroomWardrobeBlockEntity extends LootableContainerBlockEntity implements ScreenHandlerFactory, SidedInventory {
	...
	public LuphieMushroomWardrobeBlockEntity(BlockPos position, BlockState state) {
		super(LuphieclutteredmodModBlockEntities.LUPHIE_MUSHROOM_WARDROBE, position, state);
	}
	...
	public Text getContainerName() {
		return Text.literal("luphie_mushroom_wardrobe");
	}
	...
	public Text getDisplayName() {
		return Text.literal("Mushroom Wardrobe");
	}
