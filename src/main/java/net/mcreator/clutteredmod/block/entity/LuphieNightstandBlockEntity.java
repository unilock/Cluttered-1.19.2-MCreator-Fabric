...
public class LuphieNightstandBlockEntity extends LootableContainerBlockEntity implements ScreenHandlerFactory, SidedInventory {
	...
	public LuphieNightstandBlockEntity(BlockPos position, BlockState state) {
		super(LuphieclutteredmodModBlockEntities.LUPHIE_NIGHTSTAND, position, state);
	}
	...
	public Text getContainerName() {
		return Text.literal("luphie_nightstand");
	}
	...
	public Text getDisplayName() {
		return Text.literal("Nightstand");
	}
