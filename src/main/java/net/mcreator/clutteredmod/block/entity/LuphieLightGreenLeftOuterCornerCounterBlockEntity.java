...
public class LuphieLightGreenLeftOuterCornerCounterBlockEntity extends LootableContainerBlockEntity implements ScreenHandlerFactory, SidedInventory {
	...
	public LuphieLightGreenLeftOuterCornerCounterBlockEntity(BlockPos position, BlockState state) {
		super(LuphieclutteredmodModBlockEntities.LUPHIE_LIGHT_GREEN_LEFT_OUTER_CORNER_COUNTER, position, state);
	}
	...
	public Text getContainerName() {
		return Text.literal("luphie_light_green_left_outer_corner_counter");
	}
	...
	public Text getDisplayName() {
		return Text.literal("Light Green Left Outer Corner Counter");
	}
