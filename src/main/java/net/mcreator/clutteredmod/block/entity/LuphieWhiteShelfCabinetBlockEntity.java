...
public class LuphieWhiteShelfCabinetBlockEntity extends LootableContainerBlockEntity implements ScreenHandlerFactory, SidedInventory {
	...
	public LuphieWhiteShelfCabinetBlockEntity(BlockPos position, BlockState state) {
		super(LuphieclutteredmodModBlockEntities.LUPHIE_WHITE_SHELF_CABINET, position, state);
	}
	...
	public Text getContainerName() {
		return Text.literal("luphie_white_shelf_cabinet");
	}
	...
	public Text getDisplayName() {
		return Text.literal("White Shelf Cabinet");
	}
