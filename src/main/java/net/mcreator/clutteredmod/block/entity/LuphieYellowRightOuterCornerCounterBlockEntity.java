...
public class LuphieYellowRightOuterCornerCounterBlockEntity extends LootableContainerBlockEntity implements ScreenHandlerFactory, SidedInventory {
	...
	public LuphieYellowRightOuterCornerCounterBlockEntity(BlockPos position, BlockState state) {
		super(LuphieclutteredmodModBlockEntities.LUPHIE_YELLOW_RIGHT_OUTER_CORNER_COUNTER, position, state);
	}
	...
	public Text getContainerName() {
		return Text.literal("luphie_yellow_right_outer_corner_counter");
	}
	...
	public Text getDisplayName() {
		return Text.literal("Yellow Right Outer Corner Counter");
	}
