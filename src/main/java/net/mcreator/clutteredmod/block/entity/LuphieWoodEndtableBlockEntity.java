...
public class LuphieWoodEndtableBlockEntity extends LootableContainerBlockEntity implements ScreenHandlerFactory, SidedInventory {
	private DefaultedList<ItemStack> stacks = DefaultedList.<ItemStack>ofSize(27, ItemStack.EMPTY);

	public LuphieWoodEndtableBlockEntity(BlockPos position, BlockState state) {
		super(LuphieclutteredmodModBlockEntities.LUPHIE_WOOD_ENDTABLE, position, state);
	}
	...
	public Text getContainerName() {
		return Text.literal("luphie_wood_endtable");
	}
	...
	public Text getDisplayName() {
		return Text.literal("Wood Endtable");
	}
