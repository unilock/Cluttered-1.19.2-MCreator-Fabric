...
public class LuphieSweetheartCounterABlockEntity extends LootableContainerBlockEntity implements ScreenHandlerFactory, SidedInventory {
	...
	public LuphieSweetheartCounterABlockEntity(BlockPos position, BlockState state) {
		super(LuphieclutteredmodModBlockEntities.LUPHIE_SWEETHEART_COUNTER_A, position, state);
	}
	...
	public Text getContainerName() {
		return Text.literal("luphie_sweetheart_counter_a");
	}
	...
	public Text getDisplayName() {
		return Text.literal("Sweetheart Counter A");
	}
