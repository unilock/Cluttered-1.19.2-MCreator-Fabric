...
public class LuphieLightGreenSinkCounterBlockEntity extends LootableContainerBlockEntity implements ScreenHandlerFactory, SidedInventory {
	...
	public LuphieLightGreenSinkCounterBlockEntity(BlockPos position, BlockState state) {
		super(LuphieclutteredmodModBlockEntities.LUPHIE_LIGHT_GREEN_SINK_COUNTER, position, state);
	}
	...
	public Text getContainerName() {
		return Text.literal("luphie_light_green_sink_counter");
	}
	...
	public Text getDisplayName() {
		return Text.literal("Light Green Sink Counter");
	}
