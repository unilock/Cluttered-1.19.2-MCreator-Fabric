...
public class LuphiePinkInnerCornerCabinetBlockEntity extends LootableContainerBlockEntity implements ScreenHandlerFactory, SidedInventory {
	...
	public LuphiePinkInnerCornerCabinetBlockEntity(BlockPos position, BlockState state) {
		super(LuphieclutteredmodModBlockEntities.LUPHIE_PINK_INNER_CORNER_CABINET, position, state);
	}
	...
	public Text getContainerName() {
		return Text.literal("luphie_pink_inner_corner_cabinet");
	}
	...
	public Text getDisplayName() {
		return Text.literal("Pink Inner Corner Cabinet");
	}
