...
public class LuphieChinaCabinetBlockEntity extends LootableContainerBlockEntity implements ScreenHandlerFactory, SidedInventory {
	...
	public LuphieChinaCabinetBlockEntity(BlockPos position, BlockState state) {
		super(LuphieclutteredmodModBlockEntities.LUPHIE_CHINA_CABINET, position, state);
	}
	...
	public Text getContainerName() {
		return Text.literal("luphie_china_cabinet");
	}
	...
	public Text getDisplayName() {
		return Text.literal("China Cabinet");
	}
