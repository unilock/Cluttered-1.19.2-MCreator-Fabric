...
public class LuphieLightGreenOuterCornerCabinetBlockEntity extends LootableContainerBlockEntity implements ScreenHandlerFactory, SidedInventory {
	...
	public LuphieLightGreenOuterCornerCabinetBlockEntity(BlockPos position, BlockState state) {
		super(LuphieclutteredmodModBlockEntities.LUPHIE_LIGHT_GREEN_OUTER_CORNER_CABINET, position, state);
	}
	...
	public Text getContainerName() {
		return Text.literal("luphie_light_green_outer_corner_cabinet");
	}
	...
	public Text getDisplayName() {
		return Text.literal("Light Green Outer Corner Cabinet");
	}
