...
public class LuphieYellowInnerCornerCounterBlockEntity extends LootableContainerBlockEntity implements ScreenHandlerFactory, SidedInventory {
	...
	public LuphieYellowInnerCornerCounterBlockEntity(BlockPos position, BlockState state) {
		super(LuphieclutteredmodModBlockEntities.LUPHIE_YELLOW_INNER_CORNER_COUNTER, position, state);
	}
	...
	public Text getContainerName() {
		return Text.literal("luphie_yellow_inner_corner_counter");
	}
	...
	public Text getDisplayName() {
		return Text.literal("Yellow Inner Corner Counter");
	}
