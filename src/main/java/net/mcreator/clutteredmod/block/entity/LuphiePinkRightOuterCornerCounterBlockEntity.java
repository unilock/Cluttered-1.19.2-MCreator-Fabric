...
public class LuphiePinkRightOuterCornerCounterBlockEntity extends LootableContainerBlockEntity implements ScreenHandlerFactory, SidedInventory {
	...
	public LuphiePinkRightOuterCornerCounterBlockEntity(BlockPos position, BlockState state) {
		super(LuphieclutteredmodModBlockEntities.LUPHIE_PINK_RIGHT_OUTER_CORNER_COUNTER, position, state);
	}
	...
	public Text getContainerName() {
		return Text.literal("luphie_pink_right_outer_corner_counter");
	}
	...
	public Text getDisplayName() {
		return Text.literal("Pink Right Outer Corner Counter");
	}
