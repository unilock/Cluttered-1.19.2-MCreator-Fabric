...
public class LuphieCardIndexBlockEntity extends LootableContainerBlockEntity implements ScreenHandlerFactory, SidedInventory {
	...
	public LuphieCardIndexBlockEntity(BlockPos position, BlockState state) {
		super(LuphieclutteredmodModBlockEntities.LUPHIE_CARD_INDEX, position, state);
	}
	...
	public Text getContainerName() {
		return Text.literal("luphie_card_index");
	}
	...
	public Text getDisplayName() {
		return Text.literal("Card Index");
	}
