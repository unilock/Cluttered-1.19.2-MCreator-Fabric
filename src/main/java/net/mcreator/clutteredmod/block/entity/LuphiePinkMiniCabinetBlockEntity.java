...
public class LuphiePinkMiniCabinetBlockEntity extends LootableContainerBlockEntity implements ScreenHandlerFactory, SidedInventory {
	...
	public LuphiePinkMiniCabinetBlockEntity(BlockPos position, BlockState state) {
		super(LuphieclutteredmodModBlockEntities.LUPHIE_PINK_MINI_CABINET, position, state);
	}
	...
	public Text getContainerName() {
		return Text.literal("luphie_pink_mini_cabinet");
	}
	...
	public Text getDisplayName() {
		return Text.literal("Pink Mini Cabinet");
	}
