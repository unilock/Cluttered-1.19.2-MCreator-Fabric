...
public class PurpleCabinetBlockEntity extends LootableContainerBlockEntity implements ScreenHandlerFactory, SidedInventory {
	private DefaultedList<ItemStack> stacks = DefaultedList.<ItemStack>ofSize(54, ItemStack.EMPTY);

	public PurpleCabinetBlockEntity(BlockPos position, BlockState state) {
		super(LuphieclutteredmodModBlockEntities.PURPLE_CABINET, position, state);
	}
	...
	public Text getContainerName() {
		return Text.literal("purple_cabinet");
	}
	...
	public Text getDisplayName() {
		return Text.literal("Purple Cabinet");
	}
