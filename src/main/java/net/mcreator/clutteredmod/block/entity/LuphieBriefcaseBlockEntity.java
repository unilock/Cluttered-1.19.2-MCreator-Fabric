...
public class LuphieBriefcaseBlockEntity extends LootableContainerBlockEntity implements ScreenHandlerFactory, SidedInventory {
	...
	public Text getContainerName() {
		return Text.literal("luphie_briefcase");
	}
