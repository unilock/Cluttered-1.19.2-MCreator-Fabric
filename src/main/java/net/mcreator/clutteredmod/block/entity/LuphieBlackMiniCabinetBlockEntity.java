...
public class LuphieBlackMiniCabinetBlockEntity extends LootableContainerBlockEntity implements ScreenHandlerFactory, SidedInventory {
	...
	public LuphieBlackMiniCabinetBlockEntity(BlockPos position, BlockState state) {
		super(LuphieclutteredmodModBlockEntities.LUPHIE_BLACK_MINI_CABINET, position, state);
	}
	...
	public Text getContainerName() {
		return Text.literal("luphie_black_mini_cabinet");
	}
	...
	public Text getDisplayName() {
		return Text.literal("Black Mini Cabinet");
	}
