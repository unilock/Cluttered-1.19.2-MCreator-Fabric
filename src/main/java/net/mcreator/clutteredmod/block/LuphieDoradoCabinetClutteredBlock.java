...
public class LuphieDoradoCabinetClutteredBlock extends Block implements BlockEntityProvider {
	...
	public int getComparatorOutput(BlockState blockState, World world, BlockPos pos) {
		...
		if (tileentity instanceof LuphieDoradoCabinetClutteredBlockEntity)
	...
	public static void clientInit() {
		BlockRenderLayerMap.INSTANCE.putBlock(LuphieclutteredmodModBlocks.LUPHIE_DORADO_CABINET_CLUTTERED, RenderLayer.getCutout());
	}
}
