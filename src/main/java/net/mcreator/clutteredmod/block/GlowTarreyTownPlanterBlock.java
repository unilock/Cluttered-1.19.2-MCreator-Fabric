...
public class GlowTarreyTownPlanterBlock extends Block {
	...
	public GlowTarreyTownPlanterBlock() {
		super(PROPERTIES);
	...
	public static void clientInit() {
		BlockRenderLayerMap.INSTANCE.putBlock(LuphieclutteredmodModBlocks.GLOW_TARREY_TOWN_PLANTER, RenderLayer.getSolid());
	}
}
