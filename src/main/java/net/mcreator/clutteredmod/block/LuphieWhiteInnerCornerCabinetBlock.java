...
public class LuphieWhiteInnerCornerCabinetBlock extends Block implements BlockEntityProvider {
	...
	public int getComparatorOutput(BlockState blockState, World world, BlockPos pos) {
		...
		if (tileentity instanceof LuphieWhiteInnerCornerCabinetBlockEntity)
	...
	public static void clientInit() {
		BlockRenderLayerMap.INSTANCE.putBlock(LuphieclutteredmodModBlocks.LUPHIE_WHITE_INNER_CORNER_CABINET, RenderLayer.getCutout());
	}
}
