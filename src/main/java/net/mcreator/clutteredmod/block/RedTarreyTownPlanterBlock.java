...
public class RedTarreyTownPlanterBlock extends Block {
	...
	public RedTarreyTownPlanterBlock() {
		super(PROPERTIES);
	...
	public static void clientInit() {
		BlockRenderLayerMap.INSTANCE.putBlock(LuphieclutteredmodModBlocks.RED_TARREY_TOWN_PLANTER, RenderLayer.getSolid());
	}
}
