...
public class BlueTarreyTownPlanterBlock extends Block {
	...
	public BlueTarreyTownPlanterBlock() {
		super(PROPERTIES);
	...
	public static void clientInit() {
		BlockRenderLayerMap.INSTANCE.putBlock(LuphieclutteredmodModBlocks.BLUE_TARREY_TOWN_PLANTER, RenderLayer.getSolid());
	}
}
