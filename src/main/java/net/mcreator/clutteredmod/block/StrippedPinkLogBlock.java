...
public class StrippedPinkLogBlock extends Block {
	...
	public static void clientInit() {
		BlockRenderLayerMap.INSTANCE.putBlock(LuphieclutteredmodModBlocks.STRIPPED_LUPHIE_PINK_LOG, RenderLayer.getSolid());
	}
}
