...
public class LuphieGreenFenceGateBlock extends FenceGateBlock {
	public static AbstractBlock.Settings PROPERTIES = FabricBlockSettings.create().requiresTool().sounds(BlockSoundGroup.WOOD)
			.strength(1f, 10f).requiresTool().nonOpaque().solidBlock((bs, br, bp) -> false);
