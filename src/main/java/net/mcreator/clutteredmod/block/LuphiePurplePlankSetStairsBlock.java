...
public class LuphiePurplePlankSetStairsBlock extends StairsBlock {
	...
	public static void clientInit() {
		BlockRenderLayerMap.INSTANCE.putBlock(LuphieclutteredmodModBlocks.LUPHIE_PURPLE_PLANK_SET_STAIRS, RenderLayer.getSolid());
	}
}
