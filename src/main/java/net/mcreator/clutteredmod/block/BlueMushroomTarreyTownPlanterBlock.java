...
public class BlueMushroomTarreyTownPlanterBlock extends Block {
	...
	public BlueMushroomTarreyTownPlanterBlock() {
		super(PROPERTIES);
	...
	public static void clientInit() {
		BlockRenderLayerMap.INSTANCE.putBlock(LuphieclutteredmodModBlocks.BLUE_MUSHROOM_TARREY_TOWN_PLANTER, RenderLayer.getSolid());
	}
}
