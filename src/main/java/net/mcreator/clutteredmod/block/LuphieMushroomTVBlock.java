...
public class LuphieMushroomTVBlock extends Block {
	public static Settings PROPERTIES = Settings.create().sounds(BlockSoundGroup.FUNGUS).strength(1f, 10f).luminance(s -> 3).nonOpaque().postProcess((bs, br, bp) -> true).emissiveLighting((bs, br, bp) -> true)
