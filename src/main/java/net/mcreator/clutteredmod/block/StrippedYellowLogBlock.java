...
public class StrippedYellowLogBlock extends Block {
	...
	public static void clientInit() {
		BlockRenderLayerMap.INSTANCE.putBlock(LuphieclutteredmodModBlocks.STRIPPED_LUPHIE_YELLOW_LOG, RenderLayer.getSolid());
	}
}
