...
public class StrippedPurpleLogBlock extends Block {
	...
	public static void clientInit() {
		BlockRenderLayerMap.INSTANCE.putBlock(LuphieclutteredmodModBlocks.STRIPPED_LUPHIE_PURPLE_LOG, RenderLayer.getSolid());
	}
}
