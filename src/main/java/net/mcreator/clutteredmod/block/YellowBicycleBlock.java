...
public class YellowBicycleBlock extends Block {
	...
	public static void clientInit() {
		BlockRenderLayerMap.INSTANCE.putBlock(LuphieclutteredmodModBlocks.YELLOW_BICYCLE, RenderLayer.getCutout());
	}
}
