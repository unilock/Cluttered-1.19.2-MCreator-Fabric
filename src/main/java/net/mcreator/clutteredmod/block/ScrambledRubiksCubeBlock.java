...
public class ScrambledRubiksCubeBlock extends Block {
	...
	public ScrambledRubiksCubeBlock() {
		super(PROPERTIES);
	...
	public static void clientInit() {
		BlockRenderLayerMap.INSTANCE.putBlock(LuphieclutteredmodModBlocks.SCRAMBLED_RUBIKS_CUBE, RenderLayer.getSolid());
	}
}
