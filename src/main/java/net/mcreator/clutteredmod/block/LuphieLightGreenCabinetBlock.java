...
public class LuphieLightGreenCabinetBlock extends Block implements BlockEntityProvider {
	...
	public int getComparatorOutput(BlockState blockState, World world, BlockPos pos) {
		...
		if (tileentity instanceof LuphieLightGreenCabinetBlockEntity)
	...
	public static void clientInit() {
		BlockRenderLayerMap.INSTANCE.putBlock(LuphieclutteredmodModBlocks.LUPHIE_LIGHT_GREEN_CABINET, RenderLayer.getSolid());
	}
}
