...
public class LuphieCardIndexBlock extends Block implements BlockEntityProvider {
	...
	public VoxelShape getOutlineShape(BlockState state, BlockView world, BlockPos pos, ShapeContext context) {
		...
		return (switch (state.get(FACING)) {
			default -> VoxelShapes.union(createCuboidShape(-16, 30, 0, 16, 32, 16), createCuboidShape(-15, 0, 0, 15, 30, 15));
			case NORTH -> VoxelShapes.union(createCuboidShape(0, 30, 0, 32, 32, 16), createCuboidShape(1, 0, 1, 31, 30, 16));
			case EAST -> VoxelShapes.union(createCuboidShape(0, 30, 0, 16, 32, 32), createCuboidShape(0, 0, 1, 15, 30, 31));
			case WEST -> VoxelShapes.union(createCuboidShape(0, 30, -16, 16, 32, 16), createCuboidShape(1, 0, -15, 16, 30, 15));
	...
	public int getComparatorOutput(BlockState blockState, World world, BlockPos pos) {
		...
		if (tileentity instanceof LuphieCardIndexBlockEntity)
	...
	public static void clientInit() {
		BlockRenderLayerMap.INSTANCE.putBlock(LuphieclutteredmodModBlocks.LUPHIE_CARD_INDEX, RenderLayer.getSolid());
	}
}
