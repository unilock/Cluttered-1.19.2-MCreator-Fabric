...
public class StrippedFloweringPurpleLogBlock extends Block {
	...
	public static void clientInit() {
		BlockRenderLayerMap.INSTANCE.putBlock(LuphieclutteredmodModBlocks.STRIPPED_LUPHIE_FLOWERING_PURPLE_LOG, RenderLayer.getSolid());
	}
}
