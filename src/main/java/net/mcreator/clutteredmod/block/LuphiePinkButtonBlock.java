...
public class LuphiePinkButtonBlock extends ButtonBlock {
	...
	public static void clientInit() {
		BlockRenderLayerMap.INSTANCE.putBlock(LuphieclutteredmodModBlocks.LUPHIE_PINK_BUTTON, RenderLayer.getSolid());
	}
}
