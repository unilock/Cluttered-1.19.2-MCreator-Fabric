...
public class LuphieCatKitchenCounterBBlock extends Block implements BlockEntityProvider {
	...
	public VoxelShape getOutlineShape(BlockState state, BlockView world, BlockPos pos, ShapeContext context) {
		...
		return (switch (state.get(FACING)) {
			default -> createCuboidShape(0, 0, 0, 32, 16, 16);
			case NORTH -> createCuboidShape(-16, 0, 0, 16, 16, 16);
			case EAST -> createCuboidShape(0, 0, -16, 16, 16, 16);
			case WEST -> createCuboidShape(0, 0, 0, 16, 16, 32);
	...
	public int getComparatorOutput(BlockState blockState, World world, BlockPos pos) {
		...
		if (tileentity instanceof LuphieCatKitchenCounterBBlockEntity)
	...
	public static void clientInit() {
		BlockRenderLayerMap.INSTANCE.putBlock(LuphieclutteredmodModBlocks.LUPHIE_CAT_KITCHEN_COUNTER_B, RenderLayer.getSolid());
	}
}
