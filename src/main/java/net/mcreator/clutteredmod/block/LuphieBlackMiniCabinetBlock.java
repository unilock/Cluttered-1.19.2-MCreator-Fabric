...
public class LuphieBlackMiniCabinetBlock extends Block implements BlockEntityProvider {
	...
	public int getComparatorOutput(BlockState blockState, World world, BlockPos pos) {
		...
		if (tileentity instanceof LuphieBlackMiniCabinetBlockEntity)
	...
	public static void clientInit() {
		BlockRenderLayerMap.INSTANCE.putBlock(LuphieclutteredmodModBlocks.LUPHIE_BLACK_MINI_CABINET, RenderLayer.getSolid());
	}
}
