...
public class CutePurpleBicycleBlock extends Block {
	...
	public static void clientInit() {
		BlockRenderLayerMap.INSTANCE.putBlock(LuphieclutteredmodModBlocks.CUTE_PURPLE_BICYCLE, RenderLayer.getCutout());
	}
}
