...
public class LuphieClutteredGreenDeskBlock extends Block implements BlockEntityProvider {
	...
	public int getComparatorOutput(BlockState blockState, World world, BlockPos pos) {
		...
		if (tileentity instanceof LuphieClutteredGreenDeskBlockEntity)
	...
	public static void clientInit() {
		BlockRenderLayerMap.INSTANCE.putBlock(LuphieclutteredmodModBlocks.LUPHIE_CLUTTERED_GREEN_DESK, RenderLayer.getCutout());
	}
}
