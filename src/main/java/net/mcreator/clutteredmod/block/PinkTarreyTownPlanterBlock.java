...
public class PinkTarreyTownPlanterBlock extends Block {
	...
	public PinkTarreyTownPlanterBlock() {
		super(PROPERTIES);
	...
	public static void clientInit() {
		BlockRenderLayerMap.INSTANCE.putBlock(LuphieclutteredmodModBlocks.PINK_TARREY_TOWN_PLANTER, RenderLayer.getSolid());
	}
}
