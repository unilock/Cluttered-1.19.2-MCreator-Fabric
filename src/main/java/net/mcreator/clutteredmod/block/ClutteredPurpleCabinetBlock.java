...
public class ClutteredPurpleCabinetBlock extends Block implements BlockEntityProvider {
	...
	public ClutteredPurpleCabinetBlock() {
		super(PROPERTIES);
	...
	public BlockEntity createBlockEntity(BlockPos pos, BlockState state) {
		return new ClutteredPurpleCabinetBlockEntity(pos, state);
	}
	...
	public void onStateReplaced(BlockState state, World world, BlockPos pos, BlockState newState, boolean isMoving) {
		if (state.getBlock() != newState.getBlock()) {
			BlockEntity blockEntity = world.getBlockEntity(pos);
			if (blockEntity instanceof ClutteredPurpleCabinetBlockEntity be) {
	...
	public int getComparatorOutput(BlockState blockState, World world, BlockPos pos) {
		...
		if (tileentity instanceof ClutteredPurpleCabinetBlockEntity)
	...
	public static void clientInit() {
		BlockRenderLayerMap.INSTANCE.putBlock(LuphieclutteredmodModBlocks.CLUTTERED_PURPLE_CABINET, RenderLayer.getCutout());
	}
}
