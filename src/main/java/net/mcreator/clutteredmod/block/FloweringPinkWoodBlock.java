...
public class FloweringPinkWoodBlock extends Block {
	...
	public static void clientInit() {
		BlockRenderLayerMap.INSTANCE.putBlock(LuphieclutteredmodModBlocks.LUPHIE_FLOWERING_PINK_WOOD, RenderLayer.getSolid());
	}
}
