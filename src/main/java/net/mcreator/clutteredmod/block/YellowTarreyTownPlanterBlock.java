...
public class YellowTarreyTownPlanterBlock extends Block {
	...
	public YellowTarreyTownPlanterBlock() {
		super(PROPERTIES);
	...
	public static void clientInit() {
		BlockRenderLayerMap.INSTANCE.putBlock(LuphieclutteredmodModBlocks.YELLOW_TARREY_TOWN_PLANTER, RenderLayer.getSolid());
	}
}
