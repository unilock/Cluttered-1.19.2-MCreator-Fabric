...
public class LuphieLunarObservatoryGlobeBlock extends Block {
	...
	public VoxelShape getOutlineShape(BlockState state, BlockView world, BlockPos pos, ShapeContext context) {
		...
		return (switch (state.get(FACING)) {
			default -> createCuboidShape(1, 0, 2, 15, 21, 14);
	...
	public static void clientInit() {
		BlockRenderLayerMap.INSTANCE.putBlock(LuphieclutteredmodModBlocks.LUPHIE_LUNAR_OBSERVATORY_GLOBE, RenderLayer.getSolid());
	}
}
