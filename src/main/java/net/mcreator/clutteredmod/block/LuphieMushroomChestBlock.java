...
public class LuphieMushroomChestBlock extends Block implements BlockEntityProvider {
	...
	public VoxelShape getOutlineShape(BlockState state, BlockView world, BlockPos pos, ShapeContext context) {
		...
		return (switch (state.get(FACING)) {
			default -> createCuboidShape(0, 0, 1, 16, 16, 15);
			case NORTH -> createCuboidShape(0, 0, 1, 16, 16, 15);
			case EAST -> createCuboidShape(1, 0, 0, 15, 16, 16);
			case WEST -> createCuboidShape(1, 0, 0, 15, 16, 16);
	...
	public int getComparatorOutput(BlockState blockState, World world, BlockPos pos) {
		...
		if (tileentity instanceof LuphieMushroomChestBlockEntity)
	...
	public static void clientInit() {
		BlockRenderLayerMap.INSTANCE.putBlock(LuphieclutteredmodModBlocks.LUPHIE_MUSHROOM_CHEST, RenderLayer.getSolid());
	}
}
