...
public class PurpleTarreyTownPlanterBlock extends Block {
	...
	public PurpleTarreyTownPlanterBlock() {
		super(PROPERTIES);
	...
	public static void clientInit() {
		BlockRenderLayerMap.INSTANCE.putBlock(LuphieclutteredmodModBlocks.PURPLE_TARREY_TOWN_PLANTER, RenderLayer.getSolid());
	}
}
