...
public class LilyHillsFlooringBlock extends Block {
	...
	public static void clientInit() {
		BlockRenderLayerMap.INSTANCE.putBlock(LuphieclutteredmodModBlocks.LILY_HILLS_FLOORING, RenderLayer.getSolid());
	}
}
