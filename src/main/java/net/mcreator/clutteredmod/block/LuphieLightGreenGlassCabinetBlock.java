...
public class LuphieLightGreenGlassCabinetBlock extends Block implements BlockEntityProvider {
	...
	public VoxelShape getOutlineShape(BlockState state, BlockView world, BlockPos pos, ShapeContext context) {
		...
		return (switch (state.get(FACING)) {
			default -> VoxelShapes.union(createCuboidShape(0, 14, 0, 16, 16, 10), createCuboidShape(0, 0, 0, 16, 14, 9));
			case NORTH -> VoxelShapes.union(createCuboidShape(0, 14, 6, 16, 16, 16), createCuboidShape(0, 0, 7, 16, 14, 16));
			case EAST -> VoxelShapes.union(createCuboidShape(0, 14, 0, 10, 16, 16), createCuboidShape(0, 0, 0, 9, 14, 16));
			case WEST -> VoxelShapes.union(createCuboidShape(6, 14, 0, 16, 16, 16), createCuboidShape(7, 0, 0, 16, 14, 16));
	...
	public int getComparatorOutput(BlockState blockState, World world, BlockPos pos) {
		...
		if (tileentity instanceof LuphieLightGreenGlassCabinetBlockEntity)
	...
	public static void clientInit() {
		BlockRenderLayerMap.INSTANCE.putBlock(LuphieclutteredmodModBlocks.LUPHIE_LIGHT_GREEN_GLASS_CABINET, RenderLayer.getCutout());
	}
}
