...
public class StrippedYellowWoodBlock extends Block {
	...
	public static void clientInit() {
		BlockRenderLayerMap.INSTANCE.putBlock(LuphieclutteredmodModBlocks.STRIPPED_LUPHIE_YELLOW_WOOD, RenderLayer.getSolid());
	}
}
