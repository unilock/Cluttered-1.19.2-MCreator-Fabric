...
public class LuphieGeneralStoreCabinetBlock extends Block implements BlockEntityProvider {
	...
	public VoxelShape getOutlineShape(BlockState state, BlockView world, BlockPos pos, ShapeContext context) {
		...
		return (switch (state.get(FACING)) {
			default -> VoxelShapes.union(createCuboidShape(1, 0, 0, 31, 30, 16), createCuboidShape(0, 30, 0, 32, 32, 16));
			case NORTH -> VoxelShapes.union(createCuboidShape(-15, 0, 0, 15, 30, 16), createCuboidShape(-16, 30, 0, 16, 32, 16));
			case EAST -> VoxelShapes.union(createCuboidShape(0, 0, -15, 16, 30, 15), createCuboidShape(0, 30, -16, 16, 32, 16));
			case WEST -> VoxelShapes.union(createCuboidShape(0, 0, 1, 16, 30, 31), createCuboidShape(0, 30, 0, 16, 32, 32));
	...
	public int getComparatorOutput(BlockState blockState, World world, BlockPos pos) {
		...
		if (tileentity instanceof LuphieGeneralStoreCabinetBlockEntity)
	...
	public static void clientInit() {
		BlockRenderLayerMap.INSTANCE.putBlock(LuphieclutteredmodModBlocks.LUPHIE_GENERAL_STORE_CABINET, RenderLayer.getCutout());
	}
}
