...
public class LuphieNightstandBlock extends Block implements BlockEntityProvider {
	...
	public VoxelShape getOutlineShape(BlockState state, BlockView world, BlockPos pos, ShapeContext context) {
		...
		return (switch (state.get(FACING)) {
			default -> VoxelShapes.union(createCuboidShape(0, 14, 0, 16, 16, 16), createCuboidShape(1, 0, 1, 15, 14, 15));
			case NORTH -> VoxelShapes.union(createCuboidShape(0, 14, 0, 16, 16, 16), createCuboidShape(1, 0, 1, 15, 14, 15));
			case EAST -> VoxelShapes.union(createCuboidShape(0, 14, 0, 16, 16, 16), createCuboidShape(1, 0, 1, 15, 14, 15));
			case WEST -> VoxelShapes.union(createCuboidShape(0, 14, 0, 16, 16, 16), createCuboidShape(1, 0, 1, 15, 14, 15));
	...
	public int getComparatorOutput(BlockState blockState, World world, BlockPos pos) {
		...
		if (tileentity instanceof LuphieNightstandBlockEntity)
	...
	public static void clientInit() {
		BlockRenderLayerMap.INSTANCE.putBlock(LuphieclutteredmodModBlocks.LUPHIE_NIGHTSTAND, RenderLayer.getSolid());
	}
}
